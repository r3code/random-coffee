# Random Coffee Cards — Техническое задание (v5.8)

**Версия:** 5.8 (актуальная спецификация реализованного продукта)
...
## Что изменилось в v5.8 (единообразие + счётчики + swipe back)
